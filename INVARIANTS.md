# Mega Brain V0 — Invariants (INV-001 through INV-041)

> **Status:** FROZEN FOR IMPLEMENTATION
> **Source:** MEGA_BRAIN_V0_IMPLEMENTATION_BLUEPRINT_FINAL.md, Appendix Q + ADR-0011 (AMENDED)
...
- This document (`INVARIANTS.md`) must list exactly the same 41 IDs in the same order.
